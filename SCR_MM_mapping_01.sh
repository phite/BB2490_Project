...
bowtie -S -t --best -k 1 -y -p 6 --phred33-quals --chunkmbs 64 -n 2 -l 25 -e 70 $DIR_r64 -q $DIR_OUT/$SAMPLE_NAME".BC3_rDNA_unAl" --un $DIR_OUT/$SAMPLE_NAME".BC3_r64_unAl" > $DIR_OUT/$SAMPLE_NAME".BC3_r64_mapped"
